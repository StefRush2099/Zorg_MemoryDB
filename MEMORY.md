...
- Cron Adaptive Preflight rule: every cron job should first check whether conditions changed enough to make its instructions obsolete, unsafe, misrouted, mistimed, or in need of adjustment. Safe obvious adjustments that preserve intent may be made directly; unclear/risky/scope-expanding changes should be escalated instead of blindly running stale logic.
