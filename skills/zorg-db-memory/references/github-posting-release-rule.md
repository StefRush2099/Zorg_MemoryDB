...
- Inspect local branch, dirty status, remote state, latest release, and tags.
...
- Update every affected surface: README, docs, screenshots, changelog, release notes, package metadata, package scripts, verification scripts, skill package files, support code, tarball, tag, GitHub Release body, and Release asset.
...
- Verify remote commit/tag/release/asset with `gh` or GitHub API.
