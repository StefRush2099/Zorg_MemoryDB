...
Zorg MemoryDB is an add-on package for OpenClaw. The upstream OpenClaw project provides the gateway, channel runtime, sessions, tools, node apps, and skill loading system.
...
Do not vendor the full OpenClaw source tree here. Pull OpenClaw from upstream and apply Zorg MemoryDB as a package layer.
